...
public class UsandoList3 {

	public static void main(String[] args) {
		// Criando uma lista dinâmica
		ArrayList<Aluno> lista = new ArrayList<Aluno>(); // só permite adiconar valores referentes ao objeto aluno
		...
		// Imprimindo os objetos na tela forma 1 - não dá certo pois não imprime OS
		// DADOS do objeto
		/*
		...
		/*
		 * for (int i = 0; i < lista.size(); i++) { Aluno a = new Aluno(); a = (Aluno)
		 * lista.get(i); System.out.println("Nome: " + a.getNome() + "\nMatricula: " +
		 * a.getMatricula() + "\nData de nascimento: " +
